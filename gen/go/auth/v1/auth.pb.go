...
const file_auth_v1_auth_proto_rawDesc = "" +
	...
	"\vAuthService\x12K\n" +
	"\fRegisterUser\x12\x1c.auth.v1.RegisterUserRequest\x1a\x1d.auth.v1.RegisterUserResponse\x12B\n" +
	"\tLoginUser\x12\x19.auth.v1.LoginUserRequest\x1a\x1a.auth.v1.LoginUserResponse\x12N\n" +
	...
	"\vGetUserInfo\x12\x1b.auth.v1.GetUserInfoRequest\x1a\x1c.auth.v1.GetUserInfoResponseB8Z6github.com/repeter513/shop-proto/gen/go/auth/v1;authv1b\x06proto3"
...
var file_auth_v1_auth_proto_goTypes = []any{
	...
	(*LoginUserRequest)(nil),      // 3: auth.v1.LoginUserRequest
	...
	(*GetUserInfoRequest)(nil),    // 9: auth.v1.GetUserInfoRequest
	(*GetUserInfoResponse)(nil),   // 10: auth.v1.GetUserInfoResponse
}
var file_auth_v1_auth_proto_depIdxs = []int32{
	0,  // 0: auth.v1.GetUserInfoResponse.user:type_name -> auth.v1.User
	1,  // 1: auth.v1.AuthService.RegisterUser:input_type -> auth.v1.RegisterUserRequest
	3,  // 2: auth.v1.AuthService.LoginUser:input_type -> auth.v1.LoginUserRequest
	...
	9,  // 5: auth.v1.AuthService.GetUserInfo:input_type -> auth.v1.GetUserInfoRequest
	2,  // 6: auth.v1.AuthService.RegisterUser:output_type -> auth.v1.RegisterUserResponse
	4,  // 7: auth.v1.AuthService.LoginUser:output_type -> auth.v1.LoginUserResponse
	...
	10, // 10: auth.v1.AuthService.GetUserInfo:output_type -> auth.v1.GetUserInfoResponse
