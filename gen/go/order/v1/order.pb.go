...
const file_order_v1_order_proto_rawDesc = "" +
	"\n" +
	"\x14order/v1/order.proto\x12\border.v1\x1a\x1fgoogle/protobuf/timestamp.proto\"\x90\x02\n" +
	"\x05Order\x12\x19\n" +
	...
	"\n" +
	"payment_id\x18\a \x01(\x03R\tpaymentId\"p\n" +
	"\tOrderItem\x12\x1d\n" +
	"\n" +
	...
	"\x12CreateOrderRequestJ\x04\b\x01\x10\x02R\auser_id\"<\n" +
	...
	"\x16ORDER_STATUS_CANCELLED\x10\x042\xf5\x02\n" +
	"\fOrderService\x12J\n" +
...
var file_order_v1_order_proto_depIdxs = []int32{
	...
	1,  // 4: order.v1.PayOrderResponse.order:type_name -> order.v1.Order
	1,  // 5: order.v1.CancelOrderResponse.order:type_name -> order.v1.Order
	1,  // 6: order.v1.GetOrderResponse.order:type_name -> order.v1.Order
	...
	5,  // 9: order.v1.OrderService.PayOrder:input_type -> order.v1.PayOrderRequest
	...
	6,  // 14: order.v1.OrderService.PayOrder:output_type -> order.v1.PayOrderResponse
	8,  // 15: order.v1.OrderService.CancelOrder:output_type -> order.v1.CancelOrderResponse
	10, // 16: order.v1.OrderService.GetOrder:output_type -> order.v1.GetOrderResponse
